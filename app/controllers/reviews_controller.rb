class ReviewsController < ApplicationController
  ...
  def set_reviews
    # No need to set reviews separately now, as it's done within the index action
  end
    ...
    if admin?
      ...
      if event.date >= Date.current
        ...
        unless admin?
          ...
          if event.nil?
            redirect_to root_path, alert: "Event not found." and return
          elsif event.category.in?(['Miscellaneous', 'Private'])
