...
class EventTicketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_ticket" do
    assert_difference("EventTicket.count") do
      post event_tickets_url, params: { event_ticket: { attendee_id: @event_ticket.attendee_id, confirmation_number: @event_ticket.confirmation_number, event_id: @event_ticket.event_id } }
    end
  ...
  test "should update event_ticket" do
    patch event_ticket_url(@event_ticket), params: { event_ticket: { attendee_id: @event_ticket.attendee_id, confirmation_number: @event_ticket.confirmation_number, event_id: @event_ticket.event_id } }
